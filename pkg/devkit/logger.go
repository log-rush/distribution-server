...
func (l *mockLogger) Debug(args ...interface{}) {
	l.handler(LogLevelDebug, l.prefix, args...)
}
...
func (l *mockLogger) Error(args ...interface{}) {
	l.handler(LogLevelError, l.prefix, args...)
}
...
func (l *mockLogger) Fatal(args ...interface{}) {
	l.handler(LogLevelFatal, l.prefix, args...)
}
...
func (l *mockLogger) Info(args ...interface{}) {
	l.handler(LogLevelInfo, l.prefix, args...)
}
...
func (l *mockLogger) Panic(args ...interface{}) {
	l.handler(LogLevelPanic, l.prefix, args...)
}
...
func (l *mockLogger) Warn(args ...interface{}) {
	l.handler(LogLevelWarn, l.prefix, args...)
}
